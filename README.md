...
#### Opt Out Steps
1) Search for listing on [spokeo.com](https://www.spokeo.com/)
1) Find your listing and click on it to see your profile.
1) Copy the url of your profile.
1) Go to their opt-out website, [spokeo.com/optout](https://www.spokeo.com/optout).
1) Paste the url of your listing
1) Enter an email (we recommend using a masked email), and perform the CAPTCHA.
1) Click verification link sent to your email.
1) You will be redirected to a final confirmation page.
...
1) Go to [mylife.com](https://www.mylife.com/) and search for your listing
